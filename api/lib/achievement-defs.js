...
const ACHIEVEMENT_DEFS = [
  ...
  { id: "sl_first_win",            title: "Puxou a alavanca",        description: "Vença sua primeira rodada no Luiz Slot",                                        icon: "🎰" },
  { id: "sl_jackpot",              title: "Jackpot do Luiz",         description: "Feche os 3 rolos no símbolo 🕐 no Luiz Slot",                                   icon: "🕐" },
  { id: "sl_high_roller",          title: "Apostador de peso (Slot)",description: "Vença uma rodada com ficha Alta (30 LC) no Luiz Slot",                          icon: "💎" },
  { id: "sl_streak_3",             title: "Máquina quente",          description: "Vença 3 rodadas seguidas no Luiz Slot",                                         icon: "🔥" },
